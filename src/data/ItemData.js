export const ITEM_DATABASE = {
    ...
    "elixir_celestial": { id: "elixir_celestial", name: "Elixir Celestial", type: "consumable", value: 25, icon: "fa-flask-vial", rarity: "rare", hpRestore: 100 },
    "ration_purgatory": { id: "ration_purgatory", name: "Ração de Viagem", type: "consumable", value: 8, icon: "fa-drumstick-bite", rarity: "common", hpRestore: 15 },

    "penitent_sword": { id: "penitent_sword", name: "Espada do Penitente", type: "weapon_1h", modelType: "sword1h", value: 15, icon: "fa-khanda", rarity: "common", damage: 5, comboSpeed: 1.0, reach: 1.5, comboMax: 3 },
    "rusty_dagger": { id: "rusty_dagger", name: "Adaga Enferrujada", type: "weapon_1h", modelType: "knife", value: 8, icon: "fa-khanda", rarity: "common", damage: 3, comboSpeed: 1.5, reach: 1.0, comboMax: 4 },
    "iron_sword": { id: "iron_sword", name: "Espada de Ferro", type: "weapon_1h", modelType: "sword1h", value: 20, icon: "fa-khanda", rarity: "uncommon", damage: 8, comboSpeed: 1.0, reach: 1.5, comboMax: 3 },
    "greatsword": { id: "greatsword", name: "Montante de Ferro", type: "weapon_2h", modelType: "sword2h", value: 40, icon: "fa-khanda", rarity: "rare", damage: 16, comboSpeed: 0.6, reach: 2.2, comboMax: 2 },
    ...
    "gold_coin": { id: "gold_coin", name: "Moeda de Ouro", type: "currency", value: 1, icon: "fa-coins", rarity: "common" }
};
